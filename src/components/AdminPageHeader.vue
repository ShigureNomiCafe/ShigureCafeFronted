    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center transition-all duration-300 ease-in-out"
          ...
          <!-- Extra Filters Slot (Visible on Desktop) -->
      ...
      <!-- Extra Filters Slot (Visible on Mobile) -->
      <div v-if="!isSearchExpanded && $slots.extra" class="md:hidden pb-4 flex flex-wrap gap-2">
        <slot name="extra"></slot>
      </div>
    </div>
  </header>
